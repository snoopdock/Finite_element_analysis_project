...
from core.retrieval_attention_persistence import append_retrieval_attention_proposal
...
def generate_and_persist_retrieval_attention(
    ...
    or modify scientific state. The attention-history container is created only
    if at least one proposal is actually persisted.
    """
